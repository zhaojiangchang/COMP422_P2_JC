...
public class Main {
	...
	public static void main(String[] args) {
		...
		int number_of_particles = 30, number_of_iterations = 100, number_of_runs = 30, d = 50;
		double c1 = 1.49618, c2 = 1.49618;

		Swarm s = new Swarm();
		String function = "rosenbrock";
		if(function.equals("rosenbrock")){
			System.out.println("run Rosenbrock Function: ");
			s.setProblem(new RosenbrockFunction());
		}
		else if(function.equals("griewanks")){
			System.out.println("run griewanks Function: ");
			s.setProblem(new GriewanksFunction());
		}
